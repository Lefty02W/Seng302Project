...
//    @Constraints.Required
     ...
     * @param classification The type this destination is
     ...
     */
    public Destination(int destination_id, String member_email, String name, String classification, String country, String district, double latitude, double longitude) {
    ...
    /**
     * Returns the classification of the destination
     * @return
     */
    ...
    /**
     * Sets the classification of the destination
