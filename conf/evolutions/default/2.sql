...
INSERT INTO events (event_id, event_name, description, destination_id, start_date, end_date, age_restriction) VALUES
  (7, 'Event', 'description', 9, CURRENT_DATE, CURRENT_DATE, 0);

INSERT INTO events (event_id, event_name, description, destination_id, start_date, end_date, age_restriction) VALUES
  (8, 'Woodstock', 'description', 9, CURRENT_DATE, CURRENT_DATE, 0);

INSERT INTO events (event_id, event_name, description, destination_id, start_date, end_date, age_restriction) VALUES
  (9, 'Burning Man', 'description', 9, CURRENT_DATE, CURRENT_DATE, 0);

INSERT INTO events (event_id, event_name, description, destination_id, start_date, end_date, age_restriction) VALUES
  (10, 'Burning Person', 'description', 9, CURRENT_DATE, CURRENT_DATE, 0);

INSERT INTO events (event_id, event_name, description, destination_id, start_date, end_date, age_restriction) VALUES
  (11, 'Burning Yes', 'description', 9, CURRENT_DATE, CURRENT_DATE, 0);

INSERT INTO events (event_id, event_name, description, destination_id, start_date, end_date, age_restriction) VALUES
  (12, 'BigEvent', 'description', 9, CURRENT_DATE, CURRENT_DATE, 0);

INSERT INTO events (event_id, event_name, description, destination_id, start_date, end_date, age_restriction) VALUES
  (13, 'BigEvent', 'description', 9, CURRENT_DATE, CURRENT_DATE, 0);
